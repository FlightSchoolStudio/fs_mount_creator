...
# Welcome to the Flight School Mount tool!

This app serves as a quick way to set up the required local drive mounts to work with Flight School and Shotguns remote 
pipeline.